...
**Puedes llamar:** `read`, `write`, `edit`, `glob`, `grep`, `webfetch`, `websearch`, `skill`, `attest-deliverable`, `create-document`, `create-presentation`, `generate-diagram`, `phase-state`, `set-iteration-scope`, `suggest-iteration-scope`

**NO puedes llamar:** `bash`
